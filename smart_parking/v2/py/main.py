                    ...
                    if videoFilePath == None and hasIncomingVideoCaptureChanged == None:
                        ...
                        while capture.isOpened():
                            ...
                            if not result:
                                ...
                                cv.namedWindow('OOW 2020 SMART CITY USE CASE - "SMART PARKING"', cv.WINDOW_NORMAL)
                                #cv.setWindowProperty('smart-parking', 0, 1)
                                #print(screenWidth)
                                #print(screenHeight)
                                resize = ResizeWithAspectRatio(res, width=screenWidth, height=screenHeight) 
                                cv.imshow('OOW 2020 SMART CITY USE CASE - "SMART PARKING"', resize)
