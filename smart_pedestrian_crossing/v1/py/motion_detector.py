...
class MotionDetector:
    ...
    def persistPedestrianStatusData(self, condition):        
        sql = ('insert into smart_pedestrian_crossing(pedestrian, precise_counter) ' +
               'values(:pedestrian, :precise_counter)')
        ...
        try:
            ...
            with cx_Oracle.connect('gsmuser/oracle@//localhost:1521/orcl') as connection:
                ...
                with connection.cursor() as cursor:
                    ...
                    if condition == 'PEDESTRIAN:OFF':
                        cursor.execute(sql, ['OFF', time.time_ns()])
                    elif condition == 'PEDESTRIAN:ON':
