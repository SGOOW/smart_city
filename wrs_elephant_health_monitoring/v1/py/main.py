...
from smart_traffic_crossing_data import Area
...
def main():
    ...
    url = 'https://youtu.be/PmJMaIGG1Bk'
    vPafy = pafy.new(url)
    play = vPafy.getbest(preftype="mp4")
    fn = play.url
    
    
    cap = video.create_capture('C:\\smart_city\\wrs_elephant_health_monitoring\\v1\\py\\footage_1.mp4')
    #cap = cv.VideoCapture('C:\\smart_city\\wrs_elephant_health_monitoring\\v1\\py\\footage_1.mp4')
